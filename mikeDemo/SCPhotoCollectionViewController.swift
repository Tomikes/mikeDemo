//
//  SCPhotoCollectionViewController.swift
//  mikeDemo
//
...
class SCPhotoCollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    override func collectionView(collectionView: UICollectionView, didSelectItemAtIndexPath indexPath: NSIndexPath) {
        performSegueWithIdentifier("show", sender: (self.photos.objectAtIndex(indexPath.item) as! PhotoInfo).id)
    }
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "show" {
            (segue.destinationViewController as! ViewerViewController).photoID = sender!.integerValue

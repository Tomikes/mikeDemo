...
struct Five100px
{
  ...
  enum Router: URLRequestConvertible {
    ...
    static let consumerKey = "9bygMDH9LLoMXJx3fmeIEtMBhQnCFBJ98ifn5suY"
    ...
    var URLRequest: NSURLRequest {
      let (path: String, parameters: [String: AnyObject]) = {
        ...
        //编码
       // println("\(encoding.encode(URLRequest, parameters: parameters).0)")
...
final class PhotoInfo: NSObject, ResponseObjectSerializable {
  let id: Int
  let url: String
